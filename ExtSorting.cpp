...
/*
 ...
 Normal case:
 	A file that opens with more than 1 white space seprated word.
...
#include "stdafx.h"//comment out if needed
#include <iostream>
#include <string>
#include <cstring>
#include <fstream>
...
//***********************************
// outputs the sorted result to file
void outPut(char* filename)
{
	...
	for (size_t i = 0; i < lastRun.size(); i++)
	{
		out << lastRun[i];
		out << "\n";
	}
